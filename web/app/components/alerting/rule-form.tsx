      ...
      <VStack space={5}>
        ...
        <div className="rounded-lg border border-border p-4">
          ...
          <VStack space={3}>
              ...
              <VStack space={2}>
                ...
                {channels.length === 0 ? (
                  <p className="text-[12px] text-amber-500">
                    No channels configured yet. Add one from the Channels
                    section first.
                  </p>
                ) : (
                  <Select
              ...
              <>
                <VStack space={2}>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setConfigField('command', e.target.value)}
                    required
                    placeholder="/usr/local/bin/notify.sh"
                    className="min-h-[72px] font-mono text-xs text-text"
                  />
                  <p className="text-[12px] text-text-tertiary">
                    Runs as the slasha server user. Event details are available
                    as SLASHA_EVENT, SLASHA_TARGET, SLASHA_VALUE, SLASHA_DETAIL,
                    SLASHA_MESSAGE.
                  </p>
                </VStack>
                <VStack space={2}>
            ...
            <VStack space={2}>
              <Label htmlFor="rule-message">Custom message (optional)</Label>
              <Textarea
                id="rule-message"
